...
<html>
	...
	<body leftmargin="0" topmargin="0" background="media/bground.gif"  bgcolor="#ffffff" style="background-repeat: repeat-x">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="615">
			...
			<tr>
				<td colspan="4" align="right">
					<input type="button" class="bodytextsmall" value="Application Form" onclick="adminall()" disabled="true"/>
					<input type="button" class="bodytextsmall" value="H R" onclick="hr()"/>
				</td>	
			</tr>
			<tr>
				<td width="35"></td>
